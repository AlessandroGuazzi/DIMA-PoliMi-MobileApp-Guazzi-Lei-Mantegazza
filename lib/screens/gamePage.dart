...
class _GamePageState extends State<GamePage> {
  ...
  Map<String, int> countCountriesByContinent(List<String> countryCodes) {
    Map<String, List<String>> continents = {
      'Europe': ['aD', 'aL', 'aT', 'aX', 'bA', 'bE', 'bG', 'bV', 'cH', 'cY', 'cZ', 'dE', 'dK', 'eE', 'eS', 'fI', 'fO', 'fR', 'gB', 'gE', 'gG', 'gI', 'gR', 'hR', 'hU', 'iE', 'iM', 'iS', 'iT', 'jE', 'lI', 'lT', 'lU', 'lV', 'mC', 'mD', 'mE', 'mF', 'mK', 'mT', 'nL', 'nO', 'pL', 'pT', 'rO', 'rS', 'sE', 'sI', 'sJ', 'sK', 'sM', 'tF', 'vA', 'bY', 'rU', 'xK', 'uA'],
      ...
      'North America': ['aI', 'aG', 'aW', 'bB', 'bS', 'cA', 'cR', 'cU', 'dM', 'dO', 'gD', 'gT', 'hN', 'hT', 'jM', 'kN', 'kY', 'lC', 'mX', 'nI', 'pA', 'pM', 'pR', 'sV', 'sX', 'tC', 'tT', 'uS', 'vC', 'vG', 'vI', 'bZ', 'gL', 'gP', 'gU', 'mS', 'mQ', 'uM'],
      'South America': ['aR', 'bO', 'bR', 'cL', 'cO', 'eC', 'fK', 'gF', 'gY', 'pE', 'pY', 'sR', 'uY', 'vE', 'cW', 'bQ'],
  ...
  void initState() {
    super.initState();
    _completedTrips = DatabaseService().getCompletedTrips();
  }
          ...
          child: FutureBuilder(
              ...
              builder: (context, snapshot) {
                ...
                final List<Map<String, dynamic>> data = [
                  {'title': 'Europe', 'progress': '${map2['Europe']}/51', 'percent': map2['Europe']!/51},
                  {'title': 'Asia', 'progress': '${map2['Asia']}/70', 'percent': map2['Asia']!/70},
                  {'title': 'America Settentrionale', 'progress': '${map2['North America']}/32', 'percent': map2['North America']!/32},
                  {'title': 'America Meridionale', 'progress': '${map2['South America']}/18', 'percent': map2['South America']!/18},
                  {'title': 'Africa', 'progress': '${map2['Africa']}/60', 'percent': map2['Africa']!/60},
                  {'title': 'Oceania', 'progress': '${map2['Oceania']}/20', 'percent': map2['Oceania']!/20},
                ];
                return Column(
